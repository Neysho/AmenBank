...
class CreditController extends AbstractController
{
    ...
    /**
     * @Route("/front/mes_demande_credit", name="mes_demande_credit")
     */
...
//        return $this->render('credit/mes_credits_list.html.twig', array("credit" => $credit));
    ...
    /**
     * @Route("/back/credit_simulator", name="credit_simulator")
     */
    ...
    /**
     * @Route("/front/credit_simulator", name="credit_simulator_front")
     */
    public function credit_simulator_f(Request $request) :  Response
    {
        return $this->render('credit/Simulator_front.html.twig', [
            'controller_name' => 'AdminController',
        ]);
    }
    /**
    ...
    /**
     * @Route("/create_credit", name="create_credit")
